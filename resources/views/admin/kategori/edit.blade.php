            ...
            <div class="row">
              <div class="col-md-9 col-sm-9 col-xs-9">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form action="{{ route('kategori.update' ,$kategori->id) }}" method="post" class="form-horizontal form-label-left">
                      @method('PUT')
                      @csrf
                      <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                        
                        <label>Kategori</label>
                        <input type="text" placeholder="Masukkan Kategori" name="nama_kategori" class="form-control" value="{{ $kategori->nama_kategori }}">
