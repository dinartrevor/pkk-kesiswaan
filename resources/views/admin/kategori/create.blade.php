            ...
            <div class="row">
              <div class="col-md-9 col-sm-9 col-xs-9">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form action="{{ route('kategori.store') }}" method="post" class="form-horizontal form-label-left"  onsubmit="return validasi()">
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                        ...
                        <input type="text" placeholder="Masukkan Kategori" name="nama_kategori" class="form-control">
